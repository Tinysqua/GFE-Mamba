...
def main(args):
    ...
    #     images = torch.cat([condition, target, reconstruction], dim=-2)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_updir', type=str, default='/home/chenyifei/data/CYFData/FZJ/weights_of_models/weights_ADNI/weights/exp_4_1/')
